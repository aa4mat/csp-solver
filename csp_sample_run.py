...
# CISC 352
# csp_sample_run.py
# desc: provides a sample csp implementation of a simple math problem,
# the colouring of the australian graph, and the n-queens problem.
#
...
def w_eq_sum_x_y_z(wxyz):
    """
    takes a list of valuations and attempts to determine if this is a valid
    assignment
...
for t in itertools.product(*varDoms):
    # NOTICE use of * to convert the list v to a sequence of
    # arguments to product
    if w_eq_sum_x_y_z(t):
        sat_tuples.append(t)
